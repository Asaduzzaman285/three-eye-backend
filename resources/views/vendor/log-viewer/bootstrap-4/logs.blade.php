                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ route('log-viewer::logs.filter', [$date, $key,'password'=>request('password')]) }}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('log-viewer::logs.show', [$date,'password'=>request('password')]) }}" class="btn btn-sm btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('log-viewer::logs.download', [$date,'password'=>request('password')]) }}" class="btn btn-sm btn-success">
