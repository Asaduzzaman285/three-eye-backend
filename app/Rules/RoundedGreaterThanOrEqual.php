...
class RoundedGreaterThanOrEqual implements Rule
{
    ...
    {
        return 'The :attribute must be greater than or equal to '.Str::title(str_replace('_', ' ', $this->otherColumn)).' ('.$this->roundedOtherColumn.')';
    }
}
